...
const BLOG = {
  ...
  PSEUDO_STATIC: ture, // 伪静态路径，开启后所有文章URL都以 .html 结尾。
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一个平凡人,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '清流', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个小站，记录生活点滴', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://qingliu.eu.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '清流, 生活', // 网站关键词 英文逗号隔开
  ...
  // POST类型文章的默认路径前缀，例如默认POST类型的路径是  /post/[slug]
  ...
  DESCRIPTION:
      process.env.NEXT_PUBLIC_DESCRIPTION || '清流', // 站点描述，被notion中的页面描述覆盖
